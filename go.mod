...
replace github.com/openshift/assisted-service/api => github.com/tsorya/assisted-service/api v0.0.0-20240926132224-e7d6fe26c8ff

replace github.com/openshift/assisted-service/client => github.com/tsorya/assisted-service/client v0.0.0-20240926132224-e7d6fe26c8ff

replace github.com/openshift/assisted-service/models => github.com/tsorya/assisted-service/models v0.0.0-20240926132224-e7d6fe26c8ff
