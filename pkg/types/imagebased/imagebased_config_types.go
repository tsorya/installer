...
type InstallationConfig struct {
	...
	// coreosInstallerParams: []{"--save-partindex=6"} - this will save previously created partition number 6
	// +optional
	CoreosInstallerParams []string `json:"coreosInstallerParams,omitempty"`
}
